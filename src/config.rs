...
lazy_static::lazy_static! {
    ...
    // 预设固定密码：修改下面 map.insert 中的 "你的密码" 为你想要的实际密码
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        let mut map = HashMap::new();
        map.insert("password".to_string(), "lixin".to_string());
        // 如果你还需要预设其他硬编码选项（比如服务器地址），可以继续添加：
        // map.insert("rendezvous-server".to_string(), "your.server.com".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rust.it520147.top"];
